...
def test_character_detector_hsv_regions() -> None:
    ...
    detector = CharacterDetector(min_width=10, min_height=20, min_area=50.0)
    lower_red = (0, 100, 100)
...
def test_character_detector_debug_overlay() -> None:
    detector = CharacterDetector(min_width=10, min_height=20)
    img = np.zeros((200, 200, 3), dtype=np.uint8)
    cv2.rectangle(img, (40, 40), (70, 110), (255, 255, 255), -1)
